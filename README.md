<h1 align="center">The Orchid Project ANXCamera Mod</h1>

- Repo type **system camera**

- This camera is Based on **ANXCamera** android Mod by **teamorchidos**
Thanks to @XEonAX for base.

- usage :

git clone https://github.com/orchidnpsg/android_vendor_aeonax_ANXCamera vendor/aeonax/ANXCamera
